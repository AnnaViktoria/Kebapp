...
kebab_shop = KebabShop.new(name: "Durum Bar", address: 'Nørregade 53, 1165, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Strøgshawarma", address: 'Frederiksberggade 5, 1459, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Ahab's Kebab", address: 'Snaregade 6, 1205, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Shawarma Grill-House", address: 'Frederiksberggade 36, 1459, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Take & Eat I/S", address: 'Nørrebrogade 30, 2200, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "KEBABEN", address: 'Gothersgade 32, 1123, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Torvets Kebab", address: 'Sankt Hans Torv 24, 2200, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Palazzo Pizza", address: 'Kronprinsessegade 54, 1306, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Beyti", address: 'Nørrebrogade 13, 2200, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "King Of Kebab Pizza & Grill", address: 'Nørrebrogade 20, 2200, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Pizza Kebab House", address: 'Blågårdsgade 35, 2200, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Safir Kebab", address: 'Jagtvej 23, 2200, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Den Grønne Shawarma", address: ' Falkoner Alle 26A, 2000, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Oasen Kebab Pizza", address: 'Falkoner Alle 22, 2000, Frederiksberg', rating: 0)
...
kebab_shop = KebabShop.new(name: "Falafelkælderen", address: 'Rantzausgade 14, 2200, København', rating: 0)
...
kebab_shop = KebabShop.new(name: "Kebab Town", address: 'Falkoner Alle 44, 2000, Frederiksberg', rating: 0)
